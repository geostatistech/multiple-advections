...
double bivariate_matern_single_advection_spacetime(double *PARAM, double *l1, double *l2)
{
  double cov_val = 0.0;
  double expr = 0.0;
  double con = 0.0, con_new = 0.0;
...
double bivariate_matern_multiple_advection_spacetime(double *PARAM, double *l1, double *l2)
{
  double cov_val = 0.0;
...
double bivariate_lmc_spacetime(double *PARAM, double *l1, double *l2)
{
  double cov_val = 0.0, cov_val1 = 0.0, cov_val2 = 0.0;
...
double univariate_deformation_matern_frozen_spacetime(double *PARAM, double *l1, double *l2)
{
  double cov_val = 0.0;
  double expr = 0.0;
  double con = 0.0, con_new = 0.0;
...
double bivariate_differential_operator_spatial(double *PARAM, double *l1, double *l2)
{
  double cov_val = 0.0;
  double expr = 0.0;
...
void covfunc_(int *MODEL_NUM, double *PARAM_VECTOR, double *L1, double *L2, double *gi)
{
  ...
  if(*MODEL_NUM == 0){
    ...
    *gi = bivariate_matern_single_advection_spacetime(PARAM_VECTOR, L1, L2);
  }else if(*MODEL_NUM == 5){
    *gi = bivariate_matern_multiple_advection_spacetime(PARAM_VECTOR, L1, L2);
  }else if(*MODEL_NUM == 6){
    *gi = bivariate_lmc_spatial(PARAM_VECTOR, L1, L2);
  }else if(*MODEL_NUM == 7){
    *gi = univariate_deformation_matern_frozen_spacetime(PARAM_VECTOR, L1, L2);
  }else if(*MODEL_NUM == 8){
    *gi = bivariate_lmc_spacetime(PARAM_VECTOR, L1, L2);
  }else if(*MODEL_NUM == 9){
    ...
    *gi = bivariate_differential_operator_spatial(PARAM_VECTOR, L1, L2);
  }
}
